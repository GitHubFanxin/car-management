...
@Repository
public class ApproveDAOImpl extends BaseHibernateDAO<Approve> implements
		ApproveDAO {
	...
	public List<Approve> findApproveByPage(int offset, int pageSize,
		...
		if (condition == "" || condition == null) {
			...
			hql = "from " + Approve.class.getSimpleName()
					+ " where approverName like ? or driverName like ?";
	...
	public Approve getApproveById(long id) {
		String hql = "from " + Approve.class.getSimpleName()
				+ " where approveId=?";
