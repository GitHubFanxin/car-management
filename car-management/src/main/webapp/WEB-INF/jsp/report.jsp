...
<body>
				...
				<div class="panel panel-blue panel-widget ">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large" id="totalCost">120</div>
							<div class="text-muted" >本总月花费</div>
						</div>
					</div>
				</div>
			</div>
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-orange panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large" id="routeCount">52</div>
							<div class="text-muted">本月行程数</div>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">近七日花费</div>
	...
	function initPanels(){
		$.ajax({
			'type' : 'post',
			'url' : 'report/findBrief',
			'success' : function(result){
				$("#totalCost").text(result.totalCost);
				$("#routeCount").text(result.routeCount);
			}
		});
	}
	</script>	
